...
public class CameraLurch : MonoBehaviour {
	...
	void Update(){
		...
		float xdisplace = -0.3f * parallaxman.rawdisplacement;


		Vector3 target =  new Vector3 (transform.position.x + xdisplace, originalpos.y - parallaxman.rawdisplacement, transform.position.z);
